...
FRAME_PER_SECONDS = 60           #最大幀數(通常不準的啦)
...
def musicdef():
    ...
    objhit = pygame.mixer.Sound(sound_base_path + 'normal-hitnormal.ogg') #打擊音效
...
def redrawGameWindow():
    global clickanimation,screen1,screen2,switch,now,score,combo,counter,copyarr,songname1,input1,songselect,xaxis
